...
class CreateBuktiFisikPermohonan extends Migration
{
    public function up()
    {
        ...
        // Migrasikan foto lama dari permohonan.bukti_fisik ke tabel baru.
        $this->db->query("
            INSERT INTO bukti_fisik_permohonan (id_permohonan, nama_file, created_at, updated_at)
            SELECT id_permohonan, bukti_fisik, NOW(), NOW()
            FROM permohonan
