...
class CreateJtiTables extends Migration
{
    public function up()
    {
        ...
        $this->forge->addField(['id_permohonan'=>['type'=>'INT','constraint'=>11,'unsigned'=>true,'auto_increment'=>true],'id_user'=>['type'=>'INT','constraint'=>11,'unsigned'=>true],'id_tujuan'=>['type'=>'INT','constraint'=>11,'unsigned'=>true],'id_status'=>['type'=>'INT','constraint'=>11,'unsigned'=>true],'keperluan'=>['type'=>'VARCHAR','constraint'=>100],'deskripsi'=>['type'=>'TEXT'],'bukti_fisik'=>['type'=>'VARCHAR','constraint'=>255,'null'=>true],'keterangan_penolakan'=>['type'=>'TEXT','null'=>true],'tanggal_pengajuan'=>['type'=>'DATETIME','null'=>true],'tanggal_selesai'=>['type'=>'DATETIME','null'=>true],'tanggal_diambil'=>['type'=>'DATETIME','null'=>true],'created_at'=>['type'=>'DATETIME','null'=>true],'updated_at'=>['type'=>'DATETIME','null'=>true]]);
